...
public class DriveFragment extends Fragment {
    ...
    public DriveFragment(MainActivity mainactivity) {
    ...
    final private ResultCallback<DriveApi.MetadataBufferResult> metadataResult = new
            ResultCallback<DriveApi.MetadataBufferResult>() {
                ...
                public void onResult(DriveApi.MetadataBufferResult result) {
                    ...
                    if(adapter == null) {
                        System.out.println("New adapter created for drive");
                        ...
                        System.out.println("Adapter is refreshed for drive");
                        fst.clear();
                        fst.addAll(temp);
                        //adapter.clear();
                        //adapter.notifyDataSetChanged();
    ...
    private ArrayList<CloudFilesModel> convertFS(DriveApi.MetadataBufferResult result) {
        ...
        System.out.println("Inside convertFS");
