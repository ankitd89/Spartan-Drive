...
public class CustomGridAdapter extends ArrayAdapter<CloudFilesModel> {

    private final FragmentActivity context;
    private final ArrayList<CloudFilesModel> item;
    private MainActivity mainActivity;

    public CustomGridAdapter(FragmentActivity context, ArrayList<CloudFilesModel> item, MainActivity mainActivity) {
