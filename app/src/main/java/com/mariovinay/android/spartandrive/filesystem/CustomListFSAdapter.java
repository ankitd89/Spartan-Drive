...
public class CustomListFSAdapter extends ArrayAdapter<FileSystemModel> {

    private final FragmentActivity context;
    private ArrayList<FileSystemModel> item;

    public CustomListFSAdapter(FragmentActivity context, ArrayList<FileSystemModel> item) {
